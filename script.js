...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Smooth scroll for navigation links (exclude back-to-top)
  document.querySelectorAll('a[href^="#"]:not(.return-to-top)').forEach(anchor => {
  ...
  // Back-to-top handler (SAFE CHECK added)
  const backToTopBtn = document.querySelector('.return-to-top');
  if (backToTopBtn) {
